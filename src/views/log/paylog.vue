  ...
  <div>
    ...
    >
      <div slot="filters">
        <div>
          ...
          <el-select v-model="filter.state">
            ...
            <el-option label="未支付" value="PAYING"></el-option>
      ...
      <el-card shadow="never" v-if="pageInfo.extra" style="width: 100%" slot="statistic">
        ...
        <div v-if="pageInfo.extra.state != null">
          支付状态：
          <span v-if="pageInfo.extra.state === 0">未支付</span>
          <span v-if="pageInfo.extra.state === 1">支付成功</span>
          <span v-if="pageInfo.extra.state === 2">退款中</span>
          <span v-if="pageInfo.extra.state === 3">已退款</span>
        </div>
