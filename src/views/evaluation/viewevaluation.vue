<template>
  <div class="viewEvaluation">
      ...
      >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="updateEvaluation(scope.row.qid,scope.row.question)">修改</el-button>
    ...
    <el-dialog
        :title="'修改评教题目'"
        :visible.sync="updateEvaluationMessage">
      <div class="edit_user_main">
        <div><p>题目内容：</p><el-input type="textarea" :row="5" v-model="evaluation"></el-input></div>
      </div>
